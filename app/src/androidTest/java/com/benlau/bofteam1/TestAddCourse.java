        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.year),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("2020"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.courseID),
                        childAtPosition(
                                ...
                                5),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("8a"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.courseID), withText("8a"),
                        childAtPosition(
                                ...
                                5),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("8b"));
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.year), withText("2020"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("2021"));
