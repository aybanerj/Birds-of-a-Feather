...
public class ProfileEditAndCreationEspressoTEST {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void profileEditAndCreationEspressoTEST() {
        ...
        ViewInteraction appCompatEditText18 = onView(
                allOf(withId(R.id.photoField), withText("https://www.recipetineats.com/wp-content/uploads/2019/04/Beef-Pho_6.jpg"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText18.perform(replaceText("https://www.pholajolla.com/images/front_photo3_A.jpg"));

        ViewInteraction appCompatEditText19 = onView(
                allOf(withId(R.id.photoField), withText("https://www.pholajolla.com/images/front_photo3_A.jpg"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText22 = onView(
                allOf(withId(R.id.nameField), withText("PhoLover"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText22.perform(replaceText("PhoAdorer"));

        ViewInteraction appCompatEditText23 = onView(
                allOf(withId(R.id.nameField), withText("PhoAdorer"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
