...
public class DeleteAddReAddTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void deleteAddReAddTest() {
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.year), withText("2020"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("2019"));
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.courseID), withText("20"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                5),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("21"));

        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.courseID), withText("21"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText10 = onView(
                allOf(withId(R.id.year), withText("2019"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText10.perform(replaceText("2020"));
