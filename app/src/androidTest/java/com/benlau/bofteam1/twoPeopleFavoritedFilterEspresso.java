...
public class twoPeopleFavoritedFilterEspresso {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void twoPeopleFavoritedFilterEspresso() {
        ...
        ViewInteraction materialCheckBox = onView(
                allOf(withId(R.id.filter_by_fav_box), withText("Filter by Favorites"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
