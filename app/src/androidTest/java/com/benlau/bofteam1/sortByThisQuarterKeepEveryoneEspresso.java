...
public class sortByThisQuarterKeepEveryoneEspresso {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void sortByThisQuarterKeepEveryoneEspresso() {
